...
export function Footer() {
  // Read NEXT_PUBLIC_* so it works in both Server and Client components
  const name =
    process.env.NEXT_PUBLIC_COMPANY_NAME || "Amrita Global Enterprises";
  const email =
    process.env.NEXT_PUBLIC_COMPANY_EMAIL || "sales@fabricpro.com";
  const phone =
    process.env.NEXT_PUBLIC_COMPANY_PHONE || "+91 9925155141";
  const address =
    process.env.NEXT_PUBLIC_COMPANY_ADDRESS ||
    "4, Safal Prelude, Corporate Rd, Prahlad Nagar, Ahmedabad, Gujarat-380015";
        ...
        <div className="grid md:grid-cols-2 lg:grid-cols-4 gap-8">
          <div className="space-y-4">
            ...
            <p className="text-slate-300 leading-relaxed">
              Leading B2B fabric supplier connecting global manufacturers with
              premium textiles worldwide.
            </p>
