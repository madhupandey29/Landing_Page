      ...
      >
        <div className="text-center">
          ...
          <div className={`transition-all duration-300 delay-100 ${animationStep >= 3 ? "opacity-100" : "opacity-0"}`}>
            ...
            <p className="text-slate-600 text-sm mb-4">We'll get back to you within 24 hours.</p>
    ...
    <div className="fixed inset-0 z-[60] flex items-center justify-center">
      ...
      >
        ...
        >
          ...
          <p className="text-slate-600 text-sm mb-6">You're one step closer to premium fabrics!</p>
        </div>
