...
{open && (
  <div className="fixed inset-0 z-50 bg-black/40 flex justify-end">
    <div className="w-4/5 max-w-xs bg-sky-100 h-full shadow-lg p-6 flex flex-col relative transform transition-transform duration-300 ease-in-out translate-x-full animate-none" style={{ transform: 'translateX(0)' }}>
      {/* Menu Header */}
      ...
      <nav className="flex flex-col gap-3 z-10 relative">
        <a href="#products" className="py-2 px-2 text-slate-800 font-medium rounded hover:bg-slate-100" onClick={() => setOpen(false)}>
          Products
        </a>
        <a href="#about" className="py-2 px-2 text-slate-800 font-medium rounded hover:bg-slate-100" onClick={() => setOpen(false)}>
          About
        </a>
        <a href="#faq" className="py-2 px-2 text-slate-800 font-medium rounded hover:bg-slate-100" onClick={() => setOpen(false)}>
          FAQ
        </a>
        <a href="#contact" className="py-2 px-2 text-slate-800 font-medium rounded hover:bg-slate-100" onClick={() => setOpen(false)}>
          Contact
        </a>
        <a
          href="#contact"
